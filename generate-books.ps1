...
$labelLang = if ($Lang -eq "en") { "en" } elseif ($Lang -eq "es") { "es,en" } elseif ($Lang -eq "pt") { "pt,en" } elseif ($Lang -eq "fr") { "fr,en" } elseif ($Lang -eq "de") { "de,en" } elseif ($Lang -eq "it") { "it,en" } else { "ja,en" }
$varName   = if ($Lang -eq "en") { "BOOKS_DATA_EN" } elseif ($Lang -eq "es") { "BOOKS_DATA_ES" } elseif ($Lang -eq "pt") { "BOOKS_DATA_PT" } elseif ($Lang -eq "fr") { "BOOKS_DATA_FR" } elseif ($Lang -eq "de") { "BOOKS_DATA_DE" } elseif ($Lang -eq "it") { "BOOKS_DATA_IT" } else { "BOOKS_DATA" }
$OUT       = if ($Lang -eq "en") { "$PSScriptRoot\books-data-en.js" } elseif ($Lang -eq "es") { "$PSScriptRoot\books-data-es.js" } elseif ($Lang -eq "pt") { "$PSScriptRoot\books-data-pt.js" } elseif ($Lang -eq "fr") { "$PSScriptRoot\books-data-fr.js" } elseif ($Lang -eq "de") { "$PSScriptRoot\books-data-de.js" } elseif ($Lang -eq "it") { "$PSScriptRoot\books-data-it.js" } else { "$PSScriptRoot\books-data.js" }
